              ...
              {STEPS.map((s,i) => (
                <Reveal key={s.n} delay={i*0.08} className="relative pb-8 last:pb-0">
                  <motion.div className="absolute rounded-full"
                    style={{ left:'-21px', top:'4px', width:'10px', height:'10px', background:'#c9a020' }}
                    whileInView={{ boxShadow: ['0 0 0 0px rgba(201,160,32,0.3)', '0 0 0 6px rgba(201,160,32,0)', '0 0 0 0px rgba(201,160,32,0)'] }}
              ...
              <AnimatePresence mode="wait">
                {submitted ? (
                  <motion.div key="success" className="text-center py-10"
                    ...
                    <p style={{ fontSize:'0.875rem', color:'#50556e' }}>A member of the CDN leadership team will be in touch shortly.</p>
                  </motion.div>
                ) : (
